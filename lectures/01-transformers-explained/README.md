...
![Три типа задач NLP](./assets/diagrams/01_three_nlp_tasks.svg)
...
![RNN против внимания: последовательно vs параллельно](./assets/diagrams/02_rnn_vs_attention.svg)
...
![Q, K, V — словарь, ключ, значение](./assets/diagrams/03_qkv_library.svg)
...
![Архитектура трансформера: encoder и decoder](./assets/diagrams/04_transformer_architecture.svg)
